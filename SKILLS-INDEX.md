...
| ✅ [dotnet-skills](catalog/dotnet-skills.md) | development | approved | catálogo | Official .NET team skill collection covering core development, advanced scenarios, data access with Entity Framework and diagnostics. | `dotnet` `backend` |
...
| Skill | Categoria | Status | Tipo | Descrição | Tags |
|---|---|---|---|---|---|
| ✅ [google-cloud-skills](catalog/google-cloud-skills.md) | devops | approved | catálogo | Official Google skill collection for Google Cloud — authentication, foundation setup, solution architecture and multi-agent deployment. | `cloud` `ai` |
